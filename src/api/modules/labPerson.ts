...
export const labPerson = {
  ...
  addParticipant: (labPersonId: number) =>
    axios.put(`/api/labPersons/${labPersonId}/participantExperiments`),
  ...
  addResponsibleExperiment: (labPersonId: number) =>
    axios.put(`/api/labPersons/${labPersonId}/responsibleExperiments`),
  ...
  addAuthoredExperiment: (labPersonId: number) =>
    axios.put(`/api/labPersons/${labPersonId}/authoredExperiments`),
  ...
  addAreaOfExpertise: (labPersonId: number) =>
    axios.put(`/api/labPersons/${labPersonId}/areasOfExpertise`),
